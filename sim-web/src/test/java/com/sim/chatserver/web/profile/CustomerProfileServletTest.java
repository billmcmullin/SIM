...
/**
 * Parasoft Jtest UTA: Test class for CustomerProfileServlet
 *
 * @see com.sim.chatserver.web.profile.CustomerProfileServlet
 * @author bmcmullin
 */
public class CustomerProfileServletTest
{
     ...
     *
     * @see com.sim.chatserver.web.profile.CustomerProfileServlet#doGet(HttpServletRequest, HttpServletResponse)
     * @author bmcmullin
     */
    @Test
    ...
    {
        // Given
        CustomerProfileServlet underTest = new CustomerProfileServlet();
