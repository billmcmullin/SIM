...
/**
 * Parasoft Jtest UTA: Test class for AllSessionsPageServlet
 *
 * @see com.sim.chatserver.web.dashboard.sessions.AllSessionsPageServlet
 * @author bmcmullin
 */
public class AllSessionsPageServletTest
{

    /**
     * Parasoft Jtest UTA: Test for doGet(HttpServletRequest, HttpServletResponse)
     *
     * @see com.sim.chatserver.web.dashboard.sessions.AllSessionsPageServlet#doGet(HttpServletRequest,
     *      HttpServletResponse)
     * @author bmcmullin
     */
    @Test
    ...
    {
        // Given
        AllSessionsPageServlet underTest = new AllSessionsPageServlet();
