...
public class CustomerProfileStoreTest
{
    ...
    /**
     * Parasoft Jtest UTA: Test for ensureTable()
     *
     * @see com.sim.chatserver.model.CustomerProfileStore#ensureTable()
     * @author bmcmullin
     */
    @Test
    public void testEnsureTable() throws Throwable
    {
        // When
        CustomerProfileStore.ensureTable();

    }

    /**
     * Parasoft Jtest UTA: Test for loadBySessionId(String)
     *
     * @see com.sim.chatserver.model.CustomerProfileStore#loadBySessionId(String)
     * @author bmcmullin
     */
    @Test
    public void testLoadBySessionId() throws Throwable
    {
        // When
        String sessionId = null; // UTA: configured value
        CustomerProfile result = CustomerProfileStore.loadBySessionId(sessionId);
