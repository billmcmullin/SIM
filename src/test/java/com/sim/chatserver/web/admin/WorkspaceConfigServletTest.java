...
/**
 * Parasoft Jtest UTA: Test class for WorkspaceConfigServlet
 *
 * @see com.sim.chatserver.web.admin.WorkspaceConfigServlet
 * @author bmcmullin
 */
public class WorkspaceConfigServletTest
{
