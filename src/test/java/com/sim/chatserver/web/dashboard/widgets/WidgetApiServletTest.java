...
/**
 * Parasoft Jtest UTA: Test class for WidgetApiServlet
 *
 * @see com.sim.chatserver.web.dashboard.widgets.WidgetApiServlet
 * @author bmcmullin
 */
public class WidgetApiServletTest
{

    /**
     * Parasoft Jtest UTA: Test for doDelete(HttpServletRequest, HttpServletResponse)
     *
     * @see com.sim.chatserver.web.dashboard.widgets.WidgetApiServlet#doDelete(HttpServletRequest, HttpServletResponse)
     * @author bmcmullin
     */
    @Test
    ...
    {
        // Given
        WidgetApiServlet underTest = new WidgetApiServlet();
     ...
     *
     * @see com.sim.chatserver.web.dashboard.widgets.WidgetApiServlet#doGet(HttpServletRequest, HttpServletResponse)
     * @author bmcmullin
     */
    @Test
     ...
     *
     * @see com.sim.chatserver.web.dashboard.widgets.WidgetApiServlet#doPost(HttpServletRequest, HttpServletResponse)
     * @author bmcmullin
     */
    @Test
