...
public class AllSessionsServletTest
{
    ...
    public void testDoGet3() throws Throwable
    {
        ...
        // When
        HttpServletRequest req = mock(HttpServletRequest.class);
        String getParameterResult = "true"; // UTA: configured value
        ...
        when(req.getParameter(nullable(String.class))).thenReturn(getParameterResult, getParameterResult2, getParameterResult3, getParameterResult4);
