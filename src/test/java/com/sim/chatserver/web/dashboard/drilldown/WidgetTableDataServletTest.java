...
/**
 * Parasoft Jtest UTA: Test class for WidgetTableDataServlet
 *
 * @see com.sim.chatserver.web.dashboard.drilldown.WidgetTableDataServlet
 * @author bmcmullin
 */
public class WidgetTableDataServletTest
{
