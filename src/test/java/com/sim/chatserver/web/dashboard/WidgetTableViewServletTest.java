...
/**
 * Parasoft Jtest UTA: Test class for WidgetTableViewServlet
 *
 * @see com.sim.chatserver.web.dashboard.WidgetTableViewServlet
 * @author bmcmullin
 */
public class WidgetTableViewServletTest
{

    /**
     * Parasoft Jtest UTA: Test for doGet(HttpServletRequest, HttpServletResponse)
     *
     * @see com.sim.chatserver.web.dashboard.WidgetTableViewServlet#doGet(HttpServletRequest, HttpServletResponse)
     * @author bmcmullin
     */
    @Test
    ...
    {
        // Given
        WidgetTableViewServlet underTest = new WidgetTableViewServlet();
